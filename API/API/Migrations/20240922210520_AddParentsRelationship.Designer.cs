...
namespace API.Migrations
{
    ...
    [Migration("20240922210520_AddParentsRelationship")]
    partial class AddParentsRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.AlcoholItem", b =>
                {
                    ...
                    b.ToTable("AlcoholItem", (string)null);
                });

            modelBuilder.Entity("API.Models.CommonItem", b =>
                {
                    b.HasBaseType("API.Models.Item");

                    b.ToTable("CommonItem", (string)null);
                });
            ...
            modelBuilder.Entity("API.Models.AlcoholItem", b =>
                {
                    ...
                    b.HasOne("API.Models.Item", null)
                        .WithOne()
                        .HasForeignKey("API.Models.AlcoholItem", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("API.Models.CommonItem", b =>
                {
                    b.HasOne("API.Models.Item", null)
                        .WithOne()
                        .HasForeignKey("API.Models.CommonItem", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
